...
public:
	...
	void GetVisibleTargets(const FAimAssistFilter& Filter, const FAimAssistSettings& Settings, const FAimAssistOwnerViewData& OwnerData, const TArray<FMiraiAimAssistTarget>& OldTargets, OUT TArray<FMiraiAimAssistTarget>& OutNewTargets);
...
protected:
	...
	void DetermineTargetVisibility(FMiraiAimAssistTarget& Target, const FAimAssistSettings& Settings, const FAimAssistFilter& Filter, const FAimAssistOwnerViewData& OwnerData);
