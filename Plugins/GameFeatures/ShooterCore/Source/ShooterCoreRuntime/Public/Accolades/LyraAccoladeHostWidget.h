...
#include "Accolades/MiraiAccoladeDefinition.h"
#include "AsyncMixin.h"
#include "CommonUserWidget.h"
#include "GameFramework/GameplayMessageSubsystem.h"

#include "MiraiAccoladeHostWidget.generated.h"

class UObject;
class USoundBase;
class UUserWidget;
struct FDataRegistryAcquireResult;
struct FMiraiNotificationMessage;
...
struct FPendingAccoladeEntry
{
	...
	FMiraiAccoladeDefinitionRow Row; 
...
class UMiraiAccoladeHostWidget : public UCommonUserWidget, public FAsyncMixin
{
	GENERATED_BODY()
...
private:
	...
	void OnNotificationMessage(FGameplayTag Channel, const FMiraiNotificationMessage& Notification);
