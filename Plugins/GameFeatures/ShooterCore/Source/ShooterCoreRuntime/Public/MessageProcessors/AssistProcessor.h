...
private:
	void OnDamageMessage(FGameplayTag Channel, const FMiraiVerbMessage& Payload);
	void OnEliminationMessage(FGameplayTag Channel, const FMiraiVerbMessage& Payload);
