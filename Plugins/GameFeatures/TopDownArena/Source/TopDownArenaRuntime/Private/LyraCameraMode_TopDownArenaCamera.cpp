...
#include "MiraiCameraMode_TopDownArenaCamera.h"


#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiCameraMode_TopDownArenaCamera)

UMiraiCameraMode_TopDownArenaCamera::UMiraiCameraMode_TopDownArenaCamera()
{
	ArenaWidth = 1000.0f;
	ArenaHeight = 1000.0f;
}

void UMiraiCameraMode_TopDownArenaCamera::UpdateView(float DeltaTime)
{
