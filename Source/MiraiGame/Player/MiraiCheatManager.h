...
#include "MiraiCheatManager.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogMiraiCheat, Log, All);
...
class UMiraiCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(UMiraiAbilitySystemComponent* MiraiASC, float DamageAmount);
	void ApplySetByCallerHeal(UMiraiAbilitySystemComponent* MiraiASC, float HealAmount);

	UMiraiAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
