...
#include "Camera/MiraiCameraAssistInterface.h"
#include "CommonPlayerController.h"
//#include "Teams/MiraiTeamAgentInterface.h"

#include "MiraiPlayerController.generated.h"
...
/**
 * AMiraiPlayerController
 *
 *	The base player controller class used by this project.
 */
UCLASS(Config = Game, Meta = (ShortTooltip = "The base player controller class used by this project."))
class MIRAIGAME_API AMiraiPlayerController : public ACommonPlayerController, public IMiraiCameraAssistInterface/*, public IMiraiTeamAgentInterface*/
{
	GENERATED_BODY()

public:

	AMiraiPlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Mirai|PlayerController")
	...
	//~IMiraiCameraAssistInterface interface
	virtual void OnCameraPenetratingTarget() override;
	//~End of IMiraiCameraAssistInterface interface
...
protected:
	...
	void OnSettingsChanged(UMiraiSettingsShared* Settings);
...
UCLASS()
class AMiraiReplayPlayerController : public AMiraiPlayerController
{
	GENERATED_BODY()
