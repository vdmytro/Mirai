...
#include "MiraiLocalPlayer.generated.h"

struct FGenericTeamId;

class APlayerController;
class UInputMappingContext;
class UMiraiSettingsLocal;
 ...
 */
UCLASS()
class MIRAIGAME_API UMiraiLocalPlayer : public UCommonLocalPlayer/*, public IMiraiTeamAgentInterface*/
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION()
	UMiraiSettingsLocal* GetLocalSettings() const;

	/** Gets the shared setting for this player, this is read using the save game system so may not be correct until after user login */
	UFUNCTION()
	UMiraiSettingsShared* GetSharedSettings() const;
...
protected:
	void OnSharedSettingsLoaded(UMiraiSettingsShared* LoadedOrCreatedSettings);
...
private:
	UPROPERTY(Transient)
	mutable TObjectPtr<UMiraiSettingsShared> SharedSettings;
