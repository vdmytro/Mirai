...
#include "MiraiSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Mirai Simulated Input Widget" ))
class MIRAIGAME_API UMiraiSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UMiraiSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
