...
#include "MiraiGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiGameViewportClient)
...
UMiraiGameViewportClient::UMiraiGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UMiraiGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
