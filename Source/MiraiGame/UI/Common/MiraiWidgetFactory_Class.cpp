...
#include "MiraiWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiWidgetFactory_Class)

TSubclassOf<UUserWidget> UMiraiWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
