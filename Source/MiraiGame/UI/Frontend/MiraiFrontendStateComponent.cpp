...
#include "MiraiFrontendStateComponent.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiFrontendStateComponent)
...
UMiraiFrontendStateComponent::UMiraiFrontendStateComponent(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UMiraiFrontendStateComponent::BeginPlay()
{
	Super::BeginPlay();
	...
	ExperienceComponent->CallOrRegister_OnExperienceLoaded_HighPriority(FOnMiraiExperienceLoaded::FDelegate::CreateUObject(this, &ThisClass::OnExperienceLoaded));
}

void UMiraiFrontendStateComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Super::EndPlay(EndPlayReason);
}

bool UMiraiFrontendStateComponent::ShouldShowLoadingScreen(FString& OutReason) const
{
...
void UMiraiFrontendStateComponent::OnExperienceLoaded(const UMiraiExperienceDefinition* Experience)
{
...
void UMiraiFrontendStateComponent::FlowStep_WaitForUserInitialization(FControlFlowNodeRef SubFlow)
{
...
void UMiraiFrontendStateComponent::FlowStep_TryShowPressStartScreen(FControlFlowNodeRef SubFlow)
{
	...
	if (!UserSubsystem->ShouldWaitForStartInput())
	{
		...
		UserSubsystem->OnUserInitializeComplete.AddDynamic(this, &UMiraiFrontendStateComponent::OnUserInitialized);
...
void UMiraiFrontendStateComponent::OnUserInitialized(const UCommonUserInfo* UserInfo, bool bSuccess, FText Error, ECommonUserPrivilege RequestedPrivilege, ECommonUserOnlineContext OnlineContext)
{
	...
	{
		UserSubsystem->OnUserInitializeComplete.RemoveDynamic(this, &UMiraiFrontendStateComponent::OnUserInitialized);
...
void UMiraiFrontendStateComponent::FlowStep_TryJoinRequestedSession(FControlFlowNodeRef SubFlow)
{
