...
#include "MiraiReticleWidgetBase.h"

//#include "Inventory/MiraiInventoryItemInstance.h"
//#include "Weapons/MiraiRangedWeaponInstance.h"
//#include "Weapons/MiraiWeaponInstance.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiReticleWidgetBase)

UMiraiReticleWidgetBase::UMiraiReticleWidgetBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

// void UMiraiReticleWidgetBase::InitializeFromWeapon(UMiraiWeaponInstance* InWeapon)
// {
// 	WeaponInstance = InWeapon;
// 	InventoryInstance = nullptr;
// 	if (WeaponInstance)
// 	{
// 		InventoryInstance = Cast<UMiraiInventoryItemInstance>(WeaponInstance->GetInstigator());
// 	}
// 	OnWeaponInitialized();
// }


// float UMiraiReticleWidgetBase::ComputeSpreadAngle() const
// {
// 	if (const UMiraiRangedWeaponInstance* RangedWeapon = Cast<const UMiraiRangedWeaponInstance>(WeaponInstance))
// 	{
...
// bool UMiraiReticleWidgetBase::HasFirstShotAccuracy() const
// {
// 	if (const UMiraiRangedWeaponInstance* RangedWeapon = Cast<const UMiraiRangedWeaponInstance>(WeaponInstance))
// 	{
...
//float UMiraiReticleWidgetBase::ComputeMaxScreenspaceSpreadRadius() const
//{
