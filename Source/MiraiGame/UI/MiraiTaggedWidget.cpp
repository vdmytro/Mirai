...
#include "MiraiTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UMiraiTaggedWidget::UMiraiTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UMiraiTaggedWidget::NativeConstruct()
{
...
void UMiraiTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UMiraiTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UMiraiTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
