...
#include "SceneView.h"
#include "UI/IndicatorSystem/MiraiIndicatorManagerComponent.h"
...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UMiraiIndicatorManagerComponent* InManager)
{
...
{
	if (UMiraiIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
