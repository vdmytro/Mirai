...
class MIRAIGAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UMiraiIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UMiraiIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UMiraiIndicatorManagerComponent> ManagerPtr;
