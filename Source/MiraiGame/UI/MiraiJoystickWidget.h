...
#include "MiraiJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the Mirai virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="Mirai Joystick" ))
class MIRAIGAME_API UMiraiJoystickWidget : public UMiraiSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UMiraiJoystickWidget(const FObjectInitializer& ObjectInitializer);
