...
#include "MiraiPerformanceStatSubsystem.generated.h"
...
struct FMiraiPerformanceStatCache : public IPerformanceDataConsumer
{
public:
	FMiraiPerformanceStatCache(UMiraiPerformanceStatSubsystem* InSubsystem)
	...
	double GetCachedStat(EMiraiDisplayablePerformanceStat Stat) const;

protected:
	IPerformanceDataConsumer::FFrameData CachedData;
	UMiraiPerformanceStatSubsystem* MySubsystem;
...
class UMiraiPerformanceStatSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
protected:
	TSharedPtr<FMiraiPerformanceStatCache> Tracker;
};
