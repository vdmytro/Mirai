...
#include "MiraiContextEffectComponent.generated.h"
...
class MIRAIGAME_API UMiraiContextEffectComponent : public UActorComponent, public IMiraiContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UMiraiContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UMiraiContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<UMiraiContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UMiraiContextEffectsLibrary>> CurrentContextEffectsLibraries;
