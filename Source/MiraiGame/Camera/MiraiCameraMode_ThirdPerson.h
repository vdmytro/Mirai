...
#include "MiraiPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "MiraiCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UMiraiCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UMiraiCameraMode_ThirdPerson : public UMiraiCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FMiraiPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
