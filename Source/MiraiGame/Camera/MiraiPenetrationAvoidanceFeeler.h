...
#include "MiraiPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FMiraiPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FMiraiPenetrationAvoidanceFeeler()
	...
	FMiraiPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
