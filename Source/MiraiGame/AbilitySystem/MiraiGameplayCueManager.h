...
#include "MiraiGameplayCueManager.generated.h"
...
/**
 * UMiraiGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UMiraiGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UMiraiGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UMiraiGameplayCueManager* Get();
