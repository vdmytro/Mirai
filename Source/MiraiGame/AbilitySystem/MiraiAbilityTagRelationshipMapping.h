...
#include "MiraiAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FMiraiAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UMiraiAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FMiraiAbilityTagRelationship> AbilityTagRelationships;
