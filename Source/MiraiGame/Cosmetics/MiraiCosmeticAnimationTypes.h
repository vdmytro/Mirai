...
#include "MiraiCosmeticAnimationTypes.generated.h"
...
struct FMiraiAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FMiraiAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FMiraiAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FMiraiAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FMiraiAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FMiraiAnimBodyStyleSelectionEntry> MeshRules;
