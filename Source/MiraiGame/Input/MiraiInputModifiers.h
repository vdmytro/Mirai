...
#include "MiraiInputModifiers.generated.h"
...
class UMiraiSettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
...
/**
 * This is a deadzone input modifier that will have it's thresholds driven by what is in the Mirai Shared game settings. 
 */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Mirai Settings Driven Dead Zone"))
class UMiraiInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class EMiraiTargetingType : uint8
{
...
/** Applies a scalar modifier based on the current gamepad settings in Mirai Shared game settings.  */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Mirai Gamepad Sensitivity"))
class UMiraiInputModifierGamepadSensitivity : public UInputModifier
{
	GENERATED_BODY()
public:
	...
	TObjectPtr<const UMiraiAimSensitivityData> SensitivityLevelTable;

protected:
	virtual FInputActionValue ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime) override;
};

/** Applies an inversion of axis values based on a setting in the Mirai Shared game settings */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Mirai Aim Inversion Setting"))
class UMiraiInputModifierAimInversion : public UInputModifier
{
	GENERATED_BODY()
