...
#include "MiraiInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the Mirai game.
 * This will be serialized out at the same time as the Mirai Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class MIRAIGAME_API UMiraiInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MIRAIGAME_API UMiraiPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
