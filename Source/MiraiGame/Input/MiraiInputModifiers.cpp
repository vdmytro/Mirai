...
#include "MiraiInputModifiers.h"

#include "EnhancedPlayerInput.h"
#include "GameFramework/PlayerController.h"
#include "Input/MiraiAimSensitivityData.h"
#include "Player/MiraiLocalPlayer.h"
#include "Settings/MiraiSettingsShared.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiInputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogMiraiInputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// MiraiInputModifiersHelpers

namespace MiraiInputModifiersHelpers
{
	/** Returns the owning MiraiLocalPlayer of an Enhanced Player Input pointer */
	static UMiraiLocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UMiraiLocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UMiraiSettingBasedScalar

FInputActionValue UMiraiSettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UMiraiLocalPlayer* LocalPlayer = MiraiInputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UMiraiSettingsShared::StaticClass();
			UMiraiSettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UMiraiInputModifierDeadZone

FInputActionValue UMiraiInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UMiraiLocalPlayer* LocalPlayer = MiraiInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}
	
	UMiraiSettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UMiraiInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UMiraiInputModifierGamepadSensitivity

FInputActionValue UMiraiInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EMiraiGamepadSensitivity Sensitivity = (TargetingType == EMiraiTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UMiraiInputModifierAimInversion

FInputActionValue UMiraiInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UMiraiLocalPlayer* LocalPlayer = MiraiInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
