...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiExperienceDefinition)

#define LOCTEXT_NAMESPACE "MiraiSystem"

UMiraiExperienceDefinition::UMiraiExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UMiraiExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UMiraiExperienceDefinition::UpdateAssetBundleData()
{
