...
#include "MiraiGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnMiraiGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AMiraiGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	AMiraiGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Mirai|Pawn")
	const UMiraiPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnMiraiGameModePlayerInitialized OnGameModePlayerInitialized;
