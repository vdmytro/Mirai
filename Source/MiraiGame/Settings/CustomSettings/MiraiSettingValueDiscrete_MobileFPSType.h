...
//#include "Settings/MiraiMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "MiraiSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UMiraiSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UMiraiSettingValueDiscrete_MobileFPSType();
