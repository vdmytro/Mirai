...
#include "MiraiSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "Mirai"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UMiraiSettingValueDiscrete_Language::UMiraiSettingValueDiscrete_Language()
{
}

void UMiraiSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UMiraiSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UMiraiSettingValueDiscrete_Language::OnApply()
{
...
void UMiraiSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UMiraiSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UMiraiSettingsShared* Settings = CastChecked<UMiraiLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UMiraiSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UMiraiSettingsShared* Settings = CastChecked<UMiraiLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UMiraiSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UMiraiSettingsShared* Settings = CastChecked<UMiraiLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UMiraiSettingValueDiscrete_Language::GetDiscreteOptions() const
{
