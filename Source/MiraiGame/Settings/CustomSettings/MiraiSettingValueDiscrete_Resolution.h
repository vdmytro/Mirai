...
#include "MiraiSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UMiraiSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UMiraiSettingValueDiscrete_Resolution();
