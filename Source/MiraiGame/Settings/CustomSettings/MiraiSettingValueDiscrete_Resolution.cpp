...
#include "MiraiSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "MiraiSettings"

UMiraiSettingValueDiscrete_Resolution::UMiraiSettingValueDiscrete_Resolution()
{
}

void UMiraiSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UMiraiSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UMiraiSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UMiraiSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UMiraiSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UMiraiSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UMiraiSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UMiraiSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UMiraiSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UMiraiSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UMiraiSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UMiraiSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UMiraiSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UMiraiSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UMiraiSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UMiraiSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
