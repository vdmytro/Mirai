...
#include "MiraiSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UMiraiSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UMiraiSettingValueDiscreteDynamic_AudioOutputDevice() = default;
