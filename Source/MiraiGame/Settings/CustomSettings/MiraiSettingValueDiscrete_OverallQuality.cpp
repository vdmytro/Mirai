...
#include "MiraiSettingValueDiscrete_OverallQuality.h"

#include "Engine/Engine.h"
#include "Settings/MiraiSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "MiraiSettings"

UMiraiSettingValueDiscrete_OverallQuality::UMiraiSettingValueDiscrete_OverallQuality()
{
}

void UMiraiSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();
...
void UMiraiSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UMiraiSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UMiraiSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UMiraiSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UMiraiSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UMiraiSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UMiraiSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UMiraiSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
