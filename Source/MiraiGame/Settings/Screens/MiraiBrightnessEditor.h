...
#include "MiraiBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UMiraiBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UMiraiBrightnessEditor(const FObjectInitializer& Initializer);
