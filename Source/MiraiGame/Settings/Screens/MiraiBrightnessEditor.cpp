...
#include "MiraiBrightnessEditor.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MiraiBrightnessEditor)
...
UMiraiBrightnessEditor::UMiraiBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UMiraiBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void UMiraiBrightnessEditor::NativeOnActivated()
{
...
bool UMiraiBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply UMiraiBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply UMiraiBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UMiraiBrightnessEditor::HandleInputModeChanged(ECommonInputType InInputType)
{
...
void UMiraiBrightnessEditor::HandleBackClicked()
{
	DeactivateWidget();
	SSafeZone::SetGlobalSafeZoneScale(UMiraiSettingsLocal::Get()->GetSafeZone());
}

void UMiraiBrightnessEditor::HandleDoneClicked()
{
