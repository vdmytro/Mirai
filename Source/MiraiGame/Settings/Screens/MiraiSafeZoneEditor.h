...
#include "MiraiSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UMiraiSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UMiraiSafeZoneEditor(const FObjectInitializer& Initializer);
