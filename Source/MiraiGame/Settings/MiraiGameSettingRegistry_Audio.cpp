...
#include "CustomSettings/MiraiSettingValueDiscreteDynamic_AudioOutputDevice.h"
...
UGameSettingCollection* UMiraiGameSettingRegistry::InitializeAudioSettings(UMiraiLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			////////////////////////////////////////////////////////////////////////////////////
			{
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UMiraiSettingsShared>()->GetSubtitlesEnabled());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UMiraiSettingsShared>()->GetSubtitlesTextSize());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UMiraiSettingsShared>()->GetSubtitlesTextColor());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UMiraiSettingsShared>()->GetSubtitlesTextBorder());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UMiraiSettingsShared>()->GetSubtitlesBackgroundOpacity());
		...
		//----------------------------------------------------------------------------------
		{
			UMiraiSettingValueDiscreteDynamic_AudioOutputDevice* Setting = NewObject<UMiraiSettingValueDiscreteDynamic_AudioOutputDevice>();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UMiraiSettingsShared>()->GetAllowAudioInBackgroundSetting());

			Setting->AddEnumOption(EMiraiAllowBackgroundAudioSetting::Off, LOCTEXT("EMiraiAllowBackgroundAudioSetting_Off", "Off"));
			Setting->AddEnumOption(EMiraiAllowBackgroundAudioSetting::AllSounds, LOCTEXT("EMiraiAllowBackgroundAudioSetting_AllSounds", "All Sounds"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UMiraiSettingsLocal>()->IsHeadphoneModeEnabled());

			Setting->AddEditCondition(MakeShared<FWhenCondition>(
				[](const ULocalPlayer*, FGameSettingEditableState& InOutEditState)
				{
					if (!GetDefault<UMiraiSettingsLocal>()->CanModifyHeadphoneModeEnabled())
					{
