...
#if WITH_EDITOR
static TAutoConsoleVariable<bool> CVarApplyFrameRateSettingsInPIE(TEXT("Mirai.Settings.ApplyFrameRateSettingsInPIE"),
	false,
	TEXT("Should we apply frame rate settings in PIE?"),
	ECVF_Default);

static TAutoConsoleVariable<bool> CVarApplyFrontEndPerformanceOptionsInPIE(TEXT("Mirai.Settings.ApplyFrontEndPerformanceOptionsInPIE"),
	false,
	TEXT("Do we apply front-end specific performance options in PIE?"),
	ECVF_Default);

static TAutoConsoleVariable<bool> CVarApplyDeviceProfilesInPIE(TEXT("Mirai.Settings.ApplyDeviceProfilesInPIE"),
	false,
...
static TAutoConsoleVariable<int32> CVarDeviceProfileDrivenTargetFps(
	TEXT("Mirai.DeviceProfile.Console.TargetFPS"),
	-1,
...
static TAutoConsoleVariable<int32> CVarDeviceProfileDrivenFrameSyncType(
	TEXT("Mirai.DeviceProfile.Console.FrameSyncType"),
	-1,
...
static TAutoConsoleVariable<int32> CVarDeviceProfileDrivenMobileDefaultFrameRate(
	TEXT("Mirai.DeviceProfile.Mobile.DefaultFrameRate"),
	30,
...
static TAutoConsoleVariable<int32> CVarDeviceProfileDrivenMobileMaxFrameRate(
	TEXT("Mirai.DeviceProfile.Mobile.MaxFrameRate"),
	30,
...
static TAutoConsoleVariable<FString> CVarMobileQualityLimits(
	TEXT("Mirai.DeviceProfile.Mobile.OverallQualityLimits"),
	TEXT(""),
...
static TAutoConsoleVariable<FString> CVarMobileResolutionQualityLimits(
	TEXT("Mirai.DeviceProfile.Mobile.ResolutionQualityLimits"),
	TEXT(""),
...
static TAutoConsoleVariable<FString> CVarMobileResolutionQualityRecommendation(
	TEXT("Mirai.DeviceProfile.Mobile.ResolutionQualityRecommendation"),
	TEXT("0:75"),
...
FMiraiScalabilitySnapshot::FMiraiScalabilitySnapshot()
{
...
namespace MiraiSettingsHelpers
{
	...
	void FillScalabilitySettingsFromDeviceProfile(FMiraiScalabilitySnapshot& Mode, const FString& Suffix = FString())
	{
		static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
		...
		Mode = FMiraiScalabilitySnapshot();
...
void UMiraiSettingsLocal::LoadSettings(bool bForceReload)
{
	...
	MiraiSettingsHelpers::FillScalabilitySettingsFromDeviceProfile(DeviceDefaultScalabilitySettings);
...
void UMiraiSettingsLocal::ResetToCurrentSettings()
{
...
void UMiraiSettingsLocal::BeginDestroy()
{
...
UMiraiSettingsLocal* UMiraiSettingsLocal::Get()
{
	return GEngine ? CastChecked<UMiraiSettingsLocal>(GEngine->GetGameUserSettings()) : nullptr;
}

void UMiraiSettingsLocal::ConfirmVideoMode()
{
...
{
	return MiraiSettingsHelpers::GetHighestLevelOfAnyScalabilityChannel(ScalabilityQuality);
}

void UMiraiSettingsLocal::OverrideQualityLevelsToScalabilityMode(const FMiraiScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels)
{
	static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
...
void UMiraiSettingsLocal::ClampQualityLevelsToDeviceProfile(const Scalability::FQualityLevels& ClampLevels, Scalability::FQualityLevels& InOutLevels)
{
	static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
...
void UMiraiSettingsLocal::OnExperienceLoaded()
{
	ReapplyThingsDueToPossibleDeviceProfileChange();
}

void UMiraiSettingsLocal::OnHotfixDeviceProfileApplied()
{
	ReapplyThingsDueToPossibleDeviceProfileChange();
}

void UMiraiSettingsLocal::ReapplyThingsDueToPossibleDeviceProfileChange()
{
	ApplyNonResolutionSettings();
}

void UMiraiSettingsLocal::SetShouldUseFrontendPerformanceSettings(bool bInFrontEnd)
{
	bInFrontEndForPerformancePurposes = bInFrontEnd;
	UpdateEffectiveFrameRateLimit();
}

bool UMiraiSettingsLocal::ShouldUseFrontendPerformanceSettings() const
{
#if WITH_EDITOR
...
EMiraiStatDisplayMode UMiraiSettingsLocal::GetPerfStatDisplayState(EMiraiDisplayablePerformanceStat Stat) const
{
	if (const EMiraiStatDisplayMode* pMode = DisplayStatList.Find(Stat))
	{
		return *pMode;
	}
	else
	{
		return EMiraiStatDisplayMode::Hidden;
	}
}

void UMiraiSettingsLocal::SetPerfStatDisplayState(EMiraiDisplayablePerformanceStat Stat, EMiraiStatDisplayMode DisplayMode)
{
	if (DisplayMode == EMiraiStatDisplayMode::Hidden)
	{
...
void UMiraiSettingsLocal::SetDisplayGamma(float InGamma)
{
	DisplayGamma = InGamma;
	ApplyDisplayGamma();
}

void UMiraiSettingsLocal::ApplyDisplayGamma()
{
	if (GEngine)
	{
...
float UMiraiSettingsLocal::GetFrameRateLimit_OnBattery() const
{
	return FrameRateLimit_OnBattery;
}

void UMiraiSettingsLocal::SetFrameRateLimit_OnBattery(float NewLimitFPS)
{
	FrameRateLimit_OnBattery = NewLimitFPS;
	UpdateEffectiveFrameRateLimit();
}

float UMiraiSettingsLocal::GetFrameRateLimit_InMenu() const
{
	return FrameRateLimit_InMenu;
}

void UMiraiSettingsLocal::SetFrameRateLimit_InMenu(float NewLimitFPS)
{
	FrameRateLimit_InMenu = NewLimitFPS;
	UpdateEffectiveFrameRateLimit();
}

float UMiraiSettingsLocal::GetFrameRateLimit_WhenBackgrounded() const
{
	return FrameRateLimit_WhenBackgrounded;
}

void UMiraiSettingsLocal::SetFrameRateLimit_WhenBackgrounded(float NewLimitFPS)
{
	FrameRateLimit_WhenBackgrounded = NewLimitFPS;
	UpdateEffectiveFrameRateLimit();
}

float UMiraiSettingsLocal::GetFrameRateLimit_Always() const
{
	return GetFrameRateLimit();
}

void UMiraiSettingsLocal::SetFrameRateLimit_Always(float NewLimitFPS)
{
	SetFrameRateLimit(NewLimitFPS);
	UpdateEffectiveFrameRateLimit();
}

void UMiraiSettingsLocal::UpdateEffectiveFrameRateLimit()
{
...
int32 UMiraiSettingsLocal::GetDefaultMobileFrameRate()
{
	return CVarDeviceProfileDrivenMobileDefaultFrameRate.GetValueOnGameThread();
}

int32 UMiraiSettingsLocal::GetMaxMobileFrameRate()
{
	return CVarDeviceProfileDrivenMobileMaxFrameRate.GetValueOnGameThread();
}

bool UMiraiSettingsLocal::IsSupportedMobileFramePace(int32 TestFPS)
{
...
int32 UMiraiSettingsLocal::GetFirstFrameRateWithQualityLimit() const
{
	return MiraiSettingsHelpers::GetFirstFrameRateWithQualityLimit();
}

int32 UMiraiSettingsLocal::GetLowestQualityWithFrameRateLimit() const
{
	return MiraiSettingsHelpers::GetLowestQualityWithFrameRateLimit();
}

void UMiraiSettingsLocal::ResetToMobileDeviceDefaults()
{
	// Reset frame rate
...
void UMiraiSettingsLocal::ClampMobileResolutionQuality(int32 TargetFPS)
{
	...
	float MaxMobileResQuality = MiraiSettingsHelpers::GetApplicableResolutionQualityLimit(TargetFPS);
...
void UMiraiSettingsLocal::RemapMobileResolutionQuality(int32 FromFPS, int32 ToFPS)
{
	...
	float MaxScaleValue = 0.0f;
	GetResolutionScaleInformationEx(CurrentScaleNormalized, CurrentScaleValue, MinScaleValue, MaxScaleValue);
	float FromMaxMobileResQuality = MiraiSettingsHelpers::GetApplicableResolutionQualityLimit(FromFPS);
	float ToMaxMobileResQuality = MiraiSettingsHelpers::GetApplicableResolutionQualityLimit(ToFPS);
...
FString UMiraiSettingsLocal::GetDesiredDeviceProfileQualitySuffix() const
{
	return DesiredUserChosenDeviceProfileSuffix;
}

void UMiraiSettingsLocal::SetDesiredDeviceProfileQualitySuffix(const FString& InDesiredSuffix)
{
	DesiredUserChosenDeviceProfileSuffix = InDesiredSuffix;
}

void UMiraiSettingsLocal::SetHeadphoneModeEnabled(bool bEnabled)
{
...
bool UMiraiSettingsLocal::IsHeadphoneModeEnabled() const
{
	return bUseHeadphoneMode;
}

bool UMiraiSettingsLocal::CanModifyHeadphoneModeEnabled() const
{
	static IConsoleVariable* BinauralSpatializationDisabledCVar = IConsoleManager::Get().FindConsoleVariable(TEXT("au.DisableBinauralSpatialization"));
	...
	const bool bBinauralSettingControlledByOS = MiraiSettingsHelpers::HasPlatformTrait(TAG_Platform_Trait_BinauralSettingControlledByOS);
...
void UMiraiSettingsLocal::SetHDRAudioModeEnabled(bool bEnabled)
{
...
void UMiraiSettingsLocal::ApplyScalabilitySettings()
{
	Scalability::SetQualityLevels(ScalabilityQuality);
}
...
void UMiraiSettingsLocal::SetOverallVolume(float InVolume)
{
...
float UMiraiSettingsLocal::GetMusicVolume() const
{
	return MusicVolume;
}

void UMiraiSettingsLocal::SetMusicVolume(float InVolume)
{
	// Cache the incoming volume value
...
float UMiraiSettingsLocal::GetSoundFXVolume() const
{
	return SoundFXVolume;
}

void UMiraiSettingsLocal::SetSoundFXVolume(float InVolume)
{
	// Cache the incoming volume value
...
float UMiraiSettingsLocal::GetDialogueVolume() const
{
	return DialogueVolume;
}

void UMiraiSettingsLocal::SetDialogueVolume(float InVolume)
{
	// Cache the incoming volume value
...
float UMiraiSettingsLocal::GetVoiceChatVolume() const
{
	return VoiceChatVolume;
}

void UMiraiSettingsLocal::SetVoiceChatVolume(float InVolume)
{
	// Cache the incoming volume value
...
void UMiraiSettingsLocal::SetVolumeForControlBus(USoundControlBus* InSoundControlBus, float InVolume)
{
	// Check to see if references to the control buses and control bus mixes have been loaded yet
...
void UMiraiSettingsLocal::SetAudioOutputDeviceId(const FString& InAudioOutputDeviceId)
{
...
void UMiraiSettingsLocal::ApplyNonResolutionSettings()
{
...
int32 UMiraiSettingsLocal::GetOverallScalabilityLevel() const
{
...
void UMiraiSettingsLocal::SetOverallScalabilityLevel(int32 Value)
{
...
FName UMiraiSettingsLocal::GetControllerPlatform() const
{
	...
	if (GEngine)
	{
		if (const UWorld* World = GEngine->GetCurrentPlayWorld())
		{
			/*if (const UMiraiAudioSettings* MiraiAudioSettings = GetDefault<UMiraiAudioSettings>())
			{
				...
				if (UObject* ObjPath = MiraiAudioSettings->OverallVolumeControlBus.TryLoad())
				{
					...
					{
						ensureMsgf(SoundControlBus, TEXT("Overall Control Bus reference missing from Mirai Audio Settings."));
					}
				}

				if (UObject* ObjPath = MiraiAudioSettings->MusicVolumeControlBus.TryLoad())
				{
					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
					{
					...
					{
						ensureMsgf(SoundControlBus, TEXT("Music Control Bus reference missing from Mirai Audio Settings."));
					}
				}

				if (UObject* ObjPath = MiraiAudioSettings->SoundFXVolumeControlBus.TryLoad())
				{
					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
					{
					...
					{
						ensureMsgf(SoundControlBus, TEXT("SoundFX Control Bus reference missing from Mirai Audio Settings."));
					}
				}

				if (UObject* ObjPath = MiraiAudioSettings->DialogueVolumeControlBus.TryLoad())
				{
					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
					{
					...
					{
						ensureMsgf(SoundControlBus, TEXT("Dialogue Control Bus reference missing from Mirai Audio Settings."));
					}
				}

				if (UObject* ObjPath = MiraiAudioSettings->VoiceChatVolumeControlBus.TryLoad())
				{
					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
					{
					...
					{
						ensureMsgf(SoundControlBus, TEXT("VoiceChat Control Bus reference missing from Mirai Audio Settings."));
					}
				}

				if (UObject* ObjPath = MiraiAudioSettings->UserSettingsControlBusMix.TryLoad())
				{
...
void UMiraiSettingsLocal::UpdateGameModeDeviceProfileAndFps()
{
#if WITH_EDITOR
...
void UMiraiSettingsLocal::UpdateDesktopFramePacing()
{
...
void UMiraiSettingsLocal::UpdateMobileFramePacing()
{
